...
class _SeePostDetails extends State<SeePostDetails> {
  ...
  Widget build(BuildContext context) {
    ...
    final description = groupList[widget.g_id]["des"];
    final image = groupList[widget.g_id]["img"];
    final members = groupList[widget.g_id]["members_count"];
    return Scaffold(
      appBar: AppBar(
        title: Text(title),
      ),
