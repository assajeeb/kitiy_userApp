...
class ReceiveController extends GetxController with GetTickerProviderStateMixin {
...
class _ReceiveTabState extends State<ReceiveTab> {
  ...
  Widget build(BuildContext context) {
    ...
    final ReceiveController receiveController= Get.put(ReceiveController());
      ...
      body: Column(
        ...
        children: [
          ...
          TabBar(
            ...
            controller: receiveController.tabController,
              ...
              Tab(
                  child: Column(
                    ...
                    Row(
                          ...
                          crossAxisAlignment: CrossAxisAlignment.center,
                          children: [
                            Image.asset("images/icons/yellowD.png",width: 15.w,height: 15.h,),
                            SizedBox(width: 5.h,),
                            Text(
                              "0",
                              style: TextStyle(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        crossAxisAlignment: CrossAxisAlignment.center,
                        children: [
                          Image.asset("images/icons/yellowD.png",width: 25.w,height: 15.h,),
                          SizedBox(width: 5.h,),
                          Text(
                            "0",
                            style: TextStyle(
